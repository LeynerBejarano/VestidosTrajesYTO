...
class Cliente(db.Model):
    ...
    def __init__(self, cli_identificacion, cli_nombre, cli_apellido, cli_ciudad, cli_direccion, cli_nacido_mes, cli_nacido_dia, cli_email, cli_celular, cli_telefono, cli_extension, cli_cargo, cli_barrio, cli_crea, cli_modifica):
    ...
    def __repr__(self):
        ...
        <cli_crea: {}>
        <cli_modifica: {}>'''
        return texto.format(self.cli_nombre, self.cli_apellido, self.cli_ciudad, self.cli_direccion, self.cli_nacido_mes, self.cli_nacido_dia, self.cli_email, self.cli_celular, self.cli_telefono, self.cli_extension, self.cli_cargo, self.cli_barrio, self.cli_crea, self.cli_modifica)
