...
class Det_pedido(db.Model):
    __tablename__ = 'neg_tdet_pedido'
    det_id = db.Column(db.Integer, primary_key = True, autoincrement=True)
    det_pedido = db.Column(db.Integer)
    ...
    def __init__(self, det_pedido, det_clase, det_color, det_estilo, det_detalle, det_pedida, det_cortesia, det_despachada, det_devuelta, det_entregada, det_faltante, det_recogida, det_crea, det_modifica):
        self.det_pedido = det_pedido
    ...
    def __repr__(self):
        ...
        <det_faltante: {} >
        <det_recogida: {} >'''
        return texto.format(self.det_id, self.det_pedido, self.det_clase, self.det_color, self.det_estilo, self.det_detalle, self.det_pedida, self.det_cortesia, self.det_despachada, self.det_devuelta, self.det_entregada, self.det_faltante, self.det_recogida)
